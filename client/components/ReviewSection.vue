          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              <div class="review-header">
                <h3>
                  <span class="a-size-base">1-8 of {{product.reviews.length}} sadfasdf</span>
                </h3>
              </div>
                  ...
                  <span class="a-button a-button-dropdown">
                    <span class="a-button-inner">
                      <span class="a-button-text">
                        <span class="a-dropdown-prompt">Top review</span>
                      </span>
          ...
          <div class="review-footer">
            <div class="a-row">
              <span class="a-button a-button-base writeReviewButton" id="a-autoid-15">
                <span class="a-button-inner">
                  <nuxt-link :to="`/reviews/${product._id}`" class="a-button-text">Helpful</nuxt-link>
                </span>
              </span>
            </div>
          </div>
