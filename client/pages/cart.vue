          ...
          <div class="col-lg-9 col-md-8 col-sm-7">
            <div class="c-section a-spacing-top-base">
              <div class="a-row sc-cart-header sc-compact-bottom">
                <h2>Shopping Cart: {{getCartLength}}</h2>
              </div>
                        ...
                        <div class="col-sm-8 col-8">
                          ...
                          <div class="sc-action-links">
                            <select @change="onChangeQuantity($event, product)">
                              <option v-for="i in 10" :value="i" :key="i" :selected="checkQty(product.quantity,i)">Qty: &nbsp;{{i}}</option>
                            </select>
                            &nbsp;&nbsp;
                            <span>|</span>
                            &nbsp;
                  ...
                  <div>
                    <span class="a-spacing-small a-button-primary a-button-icon">
                      <span class="a-button-inner">
                        <nuxt-link to="/placeorder" class="a-button-text">Proceed to checout</nuxt-link>
                      </span>
                    </span>
                  </div>
                </div>
